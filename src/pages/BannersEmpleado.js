  ...
  const manejarEnvio = async (e) => {
    ...
    try {
      const res = await fetch(API_URL, {
        ...
        body: JSON.stringify({
          ...nuevoBanner,
          // 🔥 CORRECCIÓN: Usamos id_usuario en lugar de id
          ...
          <div className="card-body p-4">
            ...
            <form onSubmit={manejarEnvio} className="row g-3">
              ...
              <div className="col-md-6">
                ...
                <input type="url" className="form-control border-2" required value={nuevoBanner.imagen_banner} onChange={(e) => setNuevoBanner({ ...nuevoBanner, imagen_banner: e.target.value })} />
              </div>
