...
const CrearUsuarioAdmin = () => {
  ...
  useEffect(() => {
    const cargarProveedores = async () => {
      try {
        const res = await fetch("https://proyecto-e-commerce-ventasperrunas.onrender.com/api/proveedores/");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://proyecto-e-commerce-ventasperrunas.onrender.com/api/usuarios/crear-admin/",
        {
          method: "POST",
          headers: {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const proveedoresRes = await fetch(
          "https://proyecto-e-commerce-ventasperrunas.onrender.com/api/proveedores/",
        );
