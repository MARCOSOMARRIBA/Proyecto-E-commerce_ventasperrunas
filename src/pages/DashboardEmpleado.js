...
import { FiPackage, FiShoppingCart, FiTruck, FiSearch, FiImage } from 'react-icons/fi'; // 🔥 1. Agregamos FiImage
...
import BannersEmpleado from './BannersEmpleado'; // 🔥 2. Importamos el componente de banners
      ...
      <div className="row g-0 h-100">
        ...
        <div className="col-auto d-flex flex-column shadow-sm" style={{ width: '260px', backgroundColor: '#1e293b', minHeight: 'calc(100vh - 70px)' }}>
          <div className="p-4 border-bottom border-secondary">
            ...
            <div className="text-center mt-2">
              <span className="badge bg-success text-white px-3 py-2 rounded-pill">PANEL OPERATIVO</span>
            </div>
          </div>
        ...
        <div className="col" style={{ overflowY: 'auto', maxHeight: 'calc(100vh - 70px)' }}>
          ...
          <div className="p-2">
            ...
            {vistaActiva === 'banners' && <BannersEmpleado />} {/* 🔥 4. Renderizado */}
          </div>
        </div>
      </div>
    </div>
