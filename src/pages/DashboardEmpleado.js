...
import BannersEmpleado from "./BannersEmpleado";
  ...
  return (
    ...
    >
      <div className="row g-0 h-100">
        {/* SIDEBAR OSCURO */}
        <div
          className="col-auto d-flex flex-column shadow-sm"
          style={{
            width: "260px",
        ...
        >
          ...
          <ul className="nav flex-column mb-auto mt-3">
            {[
              ...
              {
                id: "pedidos",
                label: "Resurtido (Proveedores)",
                icon: <FiTruck />,
              },
              { id: "banners", label: "Gestión de Banners", icon: <FiImage /> }, // 🔥 3. Botón agregado
            ].map((item) => (
        ...
        >
          <div className="bg-white border-bottom p-3 d-flex justify-content-between align-items-center sticky-top shadow-sm">
            <div className="input-group w-50">
              ...
              <input
                ...
                placeholder="Buscar en el sistema operativo..."
              />
            </div>
            <div className="d-flex align-items-center gap-3">
              ...
              <div
                className="bg-success text-white rounded-circle d-flex align-items-center justify-content-center fw-bold fs-5"
          ...
          <div className="p-2">
            ...
            {vistaActiva === "banners" && <BannersEmpleado />}{" "}
            {/* 🔥 4. Renderizado */}
          </div>
        </div>
      </div>
